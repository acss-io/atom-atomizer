...
solidClasses.forEach(function(solidClass){
  ...
  classSuggestions.push({
        ...
        snippet: solidClass.snippet,
        displayText: solidClass.displayText,
        //replacementPrefix: 'so',
        //type: 'function',
        leftLabel: solidClass.leftLabel,
        //leftLabelHTML: '',
        //rightLabel: '',
        //rightLabelHTML: '',
        //className: '',
...
module.exports = {
  ...
  getSuggestions: function(config){
    ...
    sugArr.forEach(function(s){
      ...
      if (s.displayText.search(config.prefix) > -1)
        sugs.push(s)
    })
